...
{
    public partial class oder_control : UserControl
    {
        public oder_control(string cus_id)
        {
            InitializeComponent();
        ...
        private void oder_control_Load(object sender, EventArgs e)
        {
